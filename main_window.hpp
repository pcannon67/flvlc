...
public:
  MainWindow();
  enum class STATE : char {	MUTE, PLAY, PAUSE, 
							VOLUME, VIDEO, STOP, 
							NEXT, PREV, MENU_QUIT, 
							MENU_OPEN_FILE, MENU_OPEN_URL, PLAYLIST,
							REPEAT,	WATCH, SUBTITLES, PREFERENCES,
							SNAPSHOT
  }; 
...
private:
  ...
  void conf_button(Fl_Button* btn, STATE state, const char* tip, Fl_Pixmap& active, Fl_Pixmap& inactive);
