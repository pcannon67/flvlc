...
Fl_Menu_Item MainWindow::menu_items[] = {
 //{"&File", 0,  0, 0, FL_SUBMENU | FL_MENU_DIVIDER, FL_NORMAL_LABEL, 0, SZMENU, 0},
 {"&Open file...", 0,  (Fl_Callback*)MainWindow::cb_menu, (void*)(STATE::MENU_OPEN_FILE), 0, FL_NORMAL_LABEL, 0, SZMENU, 0},
 {"&Open URL...", 0,  (Fl_Callback*)MainWindow::cb_menu, (void*)(STATE::MENU_OPEN_URL), FL_MENU_DIVIDER, FL_NORMAL_LABEL, 0, SZMENU, 0},
 //{0},
 {"&Quit", 0,  (Fl_Callback*)MainWindow::cb_menu, (void*)(STATE::MENU_QUIT), 0, FL_NORMAL_LABEL, 0, SZMENU, 0},
 {0}
};
...
MainWindow::MainWindow() : Fl_Double_Window(0,0,445,415,"flvlc") 
{
  ...
  conf_button(btn_play_pause, STATE::PLAY, "Play", image_play_active, image_play_inactive);

  btn_stop = new Fl_Button(45, 365, 25, 25);
  conf_button(btn_stop, STATE::STOP, "Stop", image_stop_active, image_stop_inactive);

  btn_prev = new Fl_Button(75, 365, 25, 25);
  conf_button(btn_prev, STATE::PREV, "Previous media", image_prev_active, image_prev_inactive);

  btn_next = new Fl_Button(105, 365, 25, 25);
  conf_button(btn_next, STATE::NEXT, "Next media", image_next_active, image_next_inactive);
 
  btn_repeat = new Fl_Button(135, 365, 25, 25);
  conf_button(btn_repeat, STATE::REPEAT, "Repeat none", image_repeat_active, image_repeat_inactive);

  btn_watch = new Fl_Button(165, 365, 25, 25);
  conf_button(btn_watch, STATE::WATCH, "Watch off", image_watch_active, image_watch_inactive);

  btn_subtitles = new Fl_Button(195, 365, 25, 25);
  conf_button(btn_subtitles, STATE::SUBTITLES, "Subtitles / Audio", image_subtitles_active, image_subtitles_inactive);
  
  btn_snapshot = new Fl_Button(225, 365, 25, 25);
  conf_button(btn_snapshot, STATE::SNAPSHOT, "Snapshot", image_snapshot_active, image_snapshot_inactive);

  btn_preferences = new Fl_Button(255, 365, 25, 25);
  conf_button(btn_preferences, STATE::PREFERENCES, "Preferences", image_preferences_active, image_preferences_inactive);
...
//	o->color(FL_RED);
  ...
  conf_button(btn_mute, STATE::MUTE, "Mute off", image_volume_active, image_volume_inactive);
  ...
  Fl_Group *box_bar = new Fl_Group(1, 392, 443, 26);
  	  ...
  	  
	  {
  	  ...
  	  conf_button(btn_playlist, STATE::PLAYLIST, "Show playlist", image_playlist_active, image_playlist_inactive);
...
void MainWindow::conf_button(Fl_Button* btn, 
							 STATE state, 
						     const char* tip, 
						     Fl_Pixmap& active, 
						     Fl_Pixmap& inactive)
...
{
  const Fl_Menu_Item* item = menu_items->popup(Fl::event_x(), Fl::event_y(),0,0,0);
  if ( item )
  {
